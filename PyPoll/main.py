...
def print_percentages(poll_csv):
    voter_ID = str(poll.csv[0])
    county = str(poll.csv[1])
    candidate = str(poll.csv[2])



#Tried using answer below to get my answer I'm still having issues understanding what to or how to write arguments
